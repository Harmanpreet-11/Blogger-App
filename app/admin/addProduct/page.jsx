...
const page = () => {
  ...
  return (
    ...
    <form onSubmit={onSubmitHandler} className='pt-5 px-5 sm:pt-12 sm:pl-16'>
      ...
      <label htmlFor="image">
        <Image className='mt-3' src={!image?assets.upload_area:URL.createObjectURL(image)} alt='' width={140} height={70} />
      </label>
      ...
      <select name="category" onChange={onChangeHandler} value={data.category} className='w-40 mt-3 px-4 py-3 border text-gray-500'>

    ...
    <div className=' px-4 md:px-12 lg:px-28'>
        ...
        <div className='text-center my-6'>
           <h1 className='font-playfair text-3xl sm:text-5xl font-bold'>Latest Blogs</h1>
            <p className='font-playfair mt-10 max-w-[740px] m-auto text-xs sm:text-based'>✨ Stay updated with our freshest posts — insights, tutorials, and stories delivered straight from the dev desk.</p>
            <br />
